...
from text_processing import SOS_FLAG, EOS_FLAG, PAD_FLAG, MAX_LEN, voc, corpus_name, pairs, save_dir, normalizeString
...
decoder_n_layers = 2
dropoutRate = 0.1
batch_size = 100  # NOTE: MAKE THIS SMALLER IF YOU DON'T HAVE A GPU
train_loss = []
clip = 50.0
teacher_forcing_ratio = 1.0
    ...
    def forward(self, input_seq, input_length, max_length):
        ...
        if not USE_MULTINOMIAL:
            ...
            for _ in range(max_length):
                ...
                decoder_output_multi = decoder_output.data.view(
                    -1).div(TEMP).exp()
...
def evaluate(encoder, decoder, searcher, voc, sentence, max_length=MAX_LEN, temperature=False):
